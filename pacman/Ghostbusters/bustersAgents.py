...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        for LGPD in livingGhostPositionDistributions:
            maxPosition = LGPD.argMax()
            GhostPositions.append(maxPosition)
        ...
        closestAction = None
        closestActionDistance = float("inf")
        for action in legal:
            successorPosition = Actions.getSuccessor(pacmanPosition, action)
            distance = self.distancer.getDistance(successorPosition, nearestGhost)
